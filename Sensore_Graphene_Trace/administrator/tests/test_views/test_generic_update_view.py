...
class AdminGenericUpdateViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.post_data = {
            ...
            "manufacturer": "TestManufacturerUpdated",
            "resolution_width": 32,
            "resolution_height": 32,
            "refresh_rate": 15,
        }
    ...
    def test_post_only_updates_specified_product_info(self):
        # Create another ProductInfo to ensure only the specified one is updated
